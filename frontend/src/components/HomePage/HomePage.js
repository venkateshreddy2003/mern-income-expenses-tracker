        ...
        <div className="relative container px-4 mx-auto">
          <div className="xl:max-w-4xl mb-18 md:mb-16 mx-auto text-center">
            ...
            <p className="mb-6 text-lg md:text-xl text-coolGray-500 font-heading">
              Income and Expenses tracker app allows us to store and remember
              our accounts and transactions in digitalized way instead of old
              way storing and writing everything on paper
            </p>
            <a
